...
\begin{enumerate}
    ...
    \end{enumerate}
\end{enumerate}
\subsubsection{HaLo Thoughts}
\begin{enumerate}
\item The court is not all that \emph{countermajoritiarian} because it relies on its legitimacy that the Court has. When we think about institutional legitimacy it takes us to constitutional proticism. In the US everyone thinks they have the ability to interpret the constitution. \begin{enumerate}
\item Is there a really political check though, people don't really care and they are apathetic\item Also, to the extent that people become involve it is the tyranny of majority. Think Southern Manifesto\item But you could say that because everyone thinks they can interpret the constitution social movements reach first to the constitution to support their arguments.\end{enumerate}
\item Con law should be required of all students because the law and especially the constitution is the language that America debates. Lawyers have a special civic role to help people understand what the Constitution means. Because the constitution is how we talk about fairness. 
\end{enumerate}
